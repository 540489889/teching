<template>
  <div class="bookList">
    ...
    <ul class="list-wrapper">
      <router-link tag="li" :to="'/resource/bookDetails?eid='+item.id" :key="item.id" v-for="(item,index) in list" class="list-item">
        <div class="boxBook">
          <div class="imgBox">
...
//        let type = this.$route.query.type
        this.http.get(this.ports.resource.ebook,res=>{
          console.log(res)
          setTimeout(() => {
