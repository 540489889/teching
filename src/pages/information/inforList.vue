<template>
  <div class="sportWrapper recommend-content">
    ...
    <div class="infoList2">
      ...
      <!--</h2>-->
      <ul>
        <router-link tag="li" :to="'./inforDetails?id='+item.id" v-for="item in list" :key="item.id">
  ...
  export default {
    ...
    methods: {
      ...
      getlistActiveData(){
        ...
        this.http.get(this.ports.information.listActive+'?type='+type,res=>{
