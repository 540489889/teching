<template>
  <div class="sportWrapper recommend-content">
    ...
    <div class="infoList2">
      ...
      <!--</h2>-->
      <ul>
        <router-link tag="li" :to="'./lawasDetails?id='+item.id" v-for="item in list" :key="item.id">
  ...
  export default {
    ...
    methods: {
      ...
      getInfoLawsData(){
        ...
        this.http.get(this.ports.information.InfoLaws+'?type='+type,res=>{
